	...
	public void configure() {
		...
		from("direct:getPartiesByIdTypeIdValue").routeId("com.modusbox.getPartiesByIdTypeIdValue").doTry()
				...
				.to("bean:customJsonMessage?method=logJsonMessage(" +
						...
						"'Tracking the request', " +
						"'Track the response', " +
						"'Request sent to, POST http://172.25.29.22:8090/tips/api/lookUp/account/resolution Payload: ${body}')")
				.to("http://172.25.29.22:8090/tips/api/lookUp/account/resolution")
